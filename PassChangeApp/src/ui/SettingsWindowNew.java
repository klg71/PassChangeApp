...
import core.Configuration;
	...
	public class SettingsWindowNew implements OnCheckedChangeListener,
			OnEditorActionListener, OnClickListener, OnItemClickListener {
		...
		public SettingsWindowNew(MainFragmentActivity mainFragmentActivity,
			...
			listViewSettings=(ListView)mainFragmentActivity.findViewById(R.id.listViewSettings);
			listViewSettings.setAdapter(new SettingsListAdapter(mainFragmentActivity));
